				...
				<div className="flex max-w-360 items-center justify-between w-full mx-25 gap-[50px] pb-10">
					...
					<div className="flex items-start flex-col gap-[17px] w-1/2">
						...
						<p className="para" style={{ fontSize: "19px" }}>
							Whether you're a Chartered Accountant, Accountant,
							Tax Consultant, Financial Advisor, or an independent
							professional, join our partner network and grow by
							helping businesses with their financial needs.
						</p>
